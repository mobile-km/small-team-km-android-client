...
//    	ListenerScroll.listener_click(HorzScrollWithImageMenu.scrollView, HorzScrollWithImageMenu.foot_view);
		...
		case MotionEvent.ACTION_MOVE:
			...
			if(scrollView_scrollX < 100  && move_deltaX > 50 && Math.abs(move_deltaY) < 50){
			}else if(move_deltaX < -10 && Math.abs(move_deltaY) < 50){
//				HorzScrollWithImageMenu.scrollView.smoothScrollTo( 320- (int)x, 0);
				ListenerScroll.set_smooth_scroll_to(MainActivity.scrollView, 320- (int)x, 0);
			}
			break;
		//在触摸抬起时	
		case MotionEvent.ACTION_UP:   
            ...
            if (velocityX > SNAP_VELOCITY) {   
            	ListenerScroll.listener_click(MainActivity.scrollView, MainActivity.foot_view);
//            	result = false;
...
//            	HorzScrollWithImageMenu.scrollView.smoothScrollTo(0, 0);
            	ListenerScroll.set_smooth_scroll_to(MainActivity.scrollView, 0, 0);
            }  
