...
import com.teamkn.Zxing.qrcode.decoding.CaptureActivityHandler;
import com.teamkn.Zxing.qrcode.decoding.InactivityTimer;
import com.teamkn.Zxing.qrcode.view.ViewfinderView;
import com.teamkn.base.activity.TeamknBaseActivity;
import com.teamkn.model.QRCodeResult;

public class CaptureActivity extends TeamknBaseActivity implements Callback {
	...
	private void finish_activity(Result obj){
		txtResult.setText(obj.getBarcodeFormat().toString() + ":"
				+ obj.getText());
		System.out.println("txtResult :  "  + obj.getBarcodeFormat().toString() + ":"
				+ obj.getText());
